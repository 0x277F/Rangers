    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length < 2) {
            ...
            if (a != null) {
                ...
                if (chest != null) {
                    a.setChest(team, chest);
                    sender.sendMessage(ChatColor.GREEN + "Set chest of arena \"" + ChatColor.YELLOW + a.getId()
                            + ChatColor.GREEN + "\" for " + ChatColor.AQUA + team.getName() + ChatColor.GREEN
                            + " to " + ChatColor.AQUA + "(" + chest.getX() + "," + chest.getY() + "," + chest.getZ()
                            + ")");
                    a.save();
                } else {
